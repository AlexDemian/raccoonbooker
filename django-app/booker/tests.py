...
from booker.models import FinanceRow, FinanceCategory, FinanceSheet, FinanceSheetEntry, Wish
from booker.factories import UserFactory, FinanceRowFactory
User = get_user_model()
...
class BookerAPITestCase(TestCase):
    ...
    def test_rows_api(self):
        ...
        self.assertEqual(FinanceRow.objects.get(pk=row.pk).amount, -100)
        """